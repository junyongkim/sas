...
proc iml;
	...
	if n0>&longshort. then do;
		...
		a=mean(a);
		print t0[label="T" format=best8.] (n0-&longshort.)[label="N" format=best8.] k[label="K" format=best8.],,a[label="MAPE" format=8.4] g[label="GRS" format=8.4] q[label="P" format=pvalue8.4];
	end;
	else do;
		print t0[label="T" format=best8.] (&longshort.)[label="N" format=best8.] k[label="K" format=best8.] (mean(b[,1]))[label="MAPE" format=8.4];
	end;
